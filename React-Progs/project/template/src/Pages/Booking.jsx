                        ...
                        <div className="col-lg-6">
                            <div className="row g-3">
                                <div className="col-6 text-end">
                                    <img className="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="C:\Users\chauh\Desktop\TOPS_Practice\TOPS_COURSE\React Js\React-Progs\project\template\public\img\about-1.jpg" style={{ marginTop: '25%' }} />
                                </div>
